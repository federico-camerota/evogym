...
class Group:
    ...
    def add_job(self, func, args, cache_size, callback):

        self.return_data.append(multiprocessing.Array("d", range(cache_size + 1)))
    ...
    def run_jobs(self, num_proc):
        ...
        for i in range(len(self.jobs)):
            self.callback[i](self.return_data[i])
